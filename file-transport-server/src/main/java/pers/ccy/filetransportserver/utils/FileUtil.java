...
import pers.ccy.filetransportserver.domain.packet.FileBurstDataPacket;
import pers.ccy.filetransportserver.domain.packet.FileBurstInstructPacket;
import pers.ccy.filetransportserver.domain.packet.FileListPacket;
...
//        }
        File file;
        if (fileBurstData.getTargetPath().length() == 0){
            file = new File(FileServer.baseUrl+fileBurstData.getFileName());
        }else {
            file = new File(fileBurstData.getTargetPath()+"/"+fileBurstData.getFileName());
        }
